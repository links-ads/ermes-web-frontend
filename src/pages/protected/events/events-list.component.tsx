...
const EventsList = (props) => {
    ...
    // const cardToShow = (props.isLoading && props.data.length === 0) ? (<Grid container justify="center"><CircularProgress disableShrink /></Grid>)
    //     : (!props.isLoading && props.data.length === 0) ? noResultsCard : itemList

    // const cardToShow = (!props.isLoading && props.data.length === 0) ? noResultsCard : itemList
